...
export default function FeedToggle({ active, onChange }) {
  const tabs = ["✨ For You", "🏫 College Feed"];

  return (
    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }}>
      <div style={{
        display: "flex", background: "white", borderRadius: 30, padding: 4,
        ...
        {tabs.map((label, i) => (
          <button
            ...
            style={{
              ...
              color: active === i ? "white" : colors.textMuted, cursor: "pointer",
              boxShadow: active === i ? "0 3px 10px rgba(79,110,247,0.3)" : "none",
            }}
          >
            {label}
          </button>
        ...
        {["🔽 Filter", "🔃 Sort"].map((label) => (
          <button
            ...
            style={{
              ...
              fontWeight: 700, color: colors.textMuted, cursor: "pointer",
            }}
          >
            {label}
          </button>
